...
using VStore.Data.ViewModel.Account;
...
using VStoreAdvance.Web.Controllers.Results;
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = VStoreAdvance.Infrastructure.Core.Users.User.CreateRandomPassword();
